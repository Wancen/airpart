...
table(colData(sce)) # counts of each cell type
...
TODO: not sure about the look of the asis results here...
...
The penalty $\lambda$ in fused lasso as well as partition groups are stored in the metadata.
