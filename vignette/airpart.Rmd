...
label <- tibble(type=levels(x),part=factor(class))
...
est <- tibble(part_wilcoxon=factor(seq_len(length(coef))), estimator=coef)
...
TODO: this will be a demo of how to graph the result?
I like this idea, probably worth wrapping as a function

```{r, eval=FALSE}
# Show result by graph
g4 <- graph( c("G1", "S", "G1", "S", "G1", "S", "G1", "S","G1", "S","G1","S","S","G2/M"), 
             isolates=c("mESC"), directed=FALSE)  
